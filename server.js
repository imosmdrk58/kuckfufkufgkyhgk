...
const IDler = {
  botID: "834196438770516020",
  botSecret: "c9ixXIhTk0IqmTn2dCdNmrjnJJEIeeHn",
  botCallbackURL: "ariuscode.ezyro.com/callback",
  sunucuID: "797889155371237446",
  sunucuDavet: "https://discord.gg/nntZk76J",
  kodLogKanalı: "841050707041583122",
  sahipRolü: "840147888717168670",
  adminRolü: "840147898582695957",
  kodPaylaşımcıRolü: "841044267685249035",
  boosterRolü: "799233022268407839",
  kodPaylaşamayacakRoller: ["840148235779047485", "841044288241532939", "841044287860506695", "841049419800903720"],
  hazırAltyapılarRolü: "841049419800903720",
  hazırSistemlerRolü: "841049419800903720",
  sistemlerrolü: "841049419800903720",
  elmasKodlarRolü: "841044287860506695",
  altınKodlarRolü: "841044288241532939",
  normalKodlarRolü: "841044295963508816"
};
...
app.post("/paylasim", (req, res) => {
  ...
  client.channels.cache.get(IDler.kodLogKanalı).send(
    ...
    .addField("Kod Sayfası", `[Tıkla!](https//ariuscode.ezyro.com/${obj.kod_rank}/${obj.id})`));
...
client.on("ready", () => {
  const listener = app.listen(process.env.PORT, function() {
    client.user.setActivity(`Rase Code`, { type:"WATCHING" })
